...
const Regiter = () => {
    ...
    return(
            <><meta charSet="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta /><meta http-equiv="X-UA-Compatible" content="ie=edge" /><title>Регистрация</title><div className="wrapper">
            <div>
                <img
                    src={blue_ellipse}
                    id="spot1" />
