...
import '../styles/login-in-styles.css';
import '../styles/login-in.scss'
...
const LoginIn = () => {
    ...
    return(
            <><meta charSet="UTF-8" /><meta name="viewport" content="width=device-width, initial-scale=1.0" /><meta /><meta http-equiv="X-UA-Compatible" content="ie=edge" /><title>Авторизация</title><div>
            <img
                src={blue_ellipse}
                id="spot1" />
        </div><div>
                ...
                <form>
                    ...
                    <p>
                        ...
                        <div className="password">
                            <input className="text-field-input password_input"
                                type="text"
                                name="password"
                                id="box3"
